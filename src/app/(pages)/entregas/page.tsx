    ...
    toast(
      (t) => (
        <div className="flex flex-col gap-3">
          <p className="font-semibold">O cliente já pagou?</p>
          <div className="flex gap-2 justify-end">
            <button
              onClick={() => {
                updatePedidoStatus(pedidoId, 'entregue', true);
                toast.dismiss(t.id);
                toast.success('Entrega finalizada com pagamento!');
              }}
            ...
            <button
              onClick={() => {
                updatePedidoStatus(pedidoId, 'entregue', false);
                toast.dismiss(t.id);
                toast.success('Entrega marcada como não paga');
              }}
